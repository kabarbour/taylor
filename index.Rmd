...
|:------------------|:--------------------|:-------------------------------|
| [**Acousticness**]{style="color:#884752;"} | `r round(results1[1,2], 5)` | p \> 0.05, not statistically significant |
| [**Danceability**]{style="color:#9f88a4;"} | `r round(results1[3,2], 5)` | p \> 0.05, not statistically significant |
| [**Liveness**]{style="color:#7a8a96;"}     | `r round(results1[4,2], 5)` | p \> 0.05, not statistically significant |
| [**Valence**]{style="color:#f5c787;"}      | `r round(results1[2,2], 5)` | p \> 0.05, not statistically significant |
...
After identifying the songs with the same producers and those with different ones, we can perform a t-test to determine if there is any reak difference between Taylor's Version songs with the same and different producers.
...
| Feature                                                   | p-value result              | interpretation                                     |
|:------------------|:--------------------|:-------------------------------|
| [**Acousticness**]{style="color:#884752;"} **Difference** | `r round(results2[1,2], 5)` | p \< 0.05, [statistically significant]{.underline} |
| [**Danceability**]{style="color:#9f88a4;"} **Difference** | `r round(results2[3,2], 5)` | p \> 0.05, not statistically significant           |
| [**Liveness**]{style="color:#7a8a96;"} **Difference**     | `r round(results2[4,2], 5)` | p \> 0.05, not statistically significant           |
| [**Valence**]{style="color:#f5c787;"} **Difference**      | `r round(results2[2,2], 5)` | p \> 0.05, not statistically significant           |
